...
htmlhelp_basename = 'django_payudoc'
...
man_pages = [
    (master_doc, 'django_payu', u'django_payu Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'django_payu', u'django_payu Documentation',
   author, 'django_payu', 'One line description of project.',
   'Miscellaneous'),
]
